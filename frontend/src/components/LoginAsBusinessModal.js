...
export default function LoginAsBusinessModal({ tenant, onClose, onSuccess, adminToken }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-gradient-to-r from-amber-500 to-yellow-400 text-white px-5 py-4 flex items-center justify-between">
        ...
        <div className="px-5 py-5 space-y-4">
          ...
          {step === 'verify' && session && (
            <>
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 space-y-1.5" data-testid="otp-sent-info">
              ...
              {session.dev_otp && (
                <div className="bg-gray-900 text-white rounded-xl p-3 flex items-center justify-between" data-testid="dev-otp-box">
                  <div>
                    <p className="text-[10px] uppercase text-amber-300 font-semibold tracking-wide">Dev mode OTP</p>
                  ...
                  <button
                    onClick={copyOtp}
                    className="text-xs bg-amber-500 hover:bg-amber-400 text-gray-900 font-semibold px-3 py-1.5 rounded-lg flex items-center gap-1"
              ...
              <label className="block">
                ...
                <input
                  ...
                  className="w-full px-3 py-3 border-2 border-gray-200 rounded-xl text-center text-xl font-mono tracking-widest focus:outline-none focus:border-amber-400"
        ...
        <div className="px-5 py-3 bg-gray-50 border-t flex gap-2">
          ...
          {step === 'verify' && (
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1.5 bg-amber-500 text-white py-2.5 rounded-lg text-sm font-semibold hover:bg-amber-600 disabled:opacity-50"
