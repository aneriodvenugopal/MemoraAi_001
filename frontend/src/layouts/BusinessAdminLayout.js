...
export default function BusinessAdminLayout({ children, pageTitle, pageSubtitle, headerRight }) {
  ...
  const menu = [
    ...
    { key: 'contacts',       label: 'Contacts',       icon: Users,        path: '/customer-portal' },
    { key: 'broadcast',      label: 'Broadcast',      icon: Megaphone,    path: '/memoraai-templates' },
    { key: 'automation',     label: 'Automation',     icon: Workflow,     path: '/business-rules',     tag: 'New' },
