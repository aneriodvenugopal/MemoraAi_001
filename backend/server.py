...
api_router.include_router(website_intelligence.router)  # Website Intelligence Engine
api_router.include_router(branding.router)             # Public branding (logo, icon, version)
...
api_router.include_router(memoraai_knowledge.router)    # Own Business GPT - Knowledge extraction
