"""
DLT Approved SMS Templates for MemoraAI
...
DLT_TEMPLATES = {
    ...
    "otp_login": {
        ...
        "name": "OTP LOGIN",
        "template": "{#var#} is your OTP to login to MemoraAI. Valid for 10 minutes. Do not share with anyone. ELNIOT SOFTWARE",
        "variables": ["otp"],
        "type": "transactional"
    },
    "otp_payment": {
        ...
        "name": "OTP PAYMENT",
        "template": "{#var#} is your OTP to confirm payment of Rs.{#var#}. Valid for 10 minutes. Do not share. MemoraAI by ELONIOT SOFTWARE",
    ...
    "payment_received": {
        ...
        "template": "Dear {#var#}, we have received Rs.{#var#} for your property booking. Receipt No: {#var#}. Thank you. MemoraAI by ELONIOT SOFTWARE",
    ...
    "token_received": {
        ...
        "name": "Token Received",
        "template": "Dear Customer, your token payment of Rs.{#var#} has been received successfully for property booking. Thank you for choosing MemoraAI. - ELONIOT SOFTWARE",
        "variables": ["amount"],
        "type": "transactional"
    },
    "payment_link": {
        ...
        "name": "Payment Link",
        "template": "Dear {#var#}, click to pay Rs.{#var#} for your property: {#var#}. MemoraAI by ELONIOT SOFTWARE",
    ...
    "booking_confirmed": {
        ...
        "template": "Dear {#var#}, your property booking is confirmed. Booking ID: {#var#}. Total Amount: Rs.{#var#}. Congratulations! MemoraAI by ELONIOT SOFTWARE",
    ...
    "emi_due": {
        ...
        "name": "EMI Due",
        "template": "Dear {#var#}, your EMI of Rs.{#var#} is due on {#var#}. Installment {#var#}. Please pay on time. MemoraAI by ELONIOT SOFTWARE",
    ...
    "emi_due_detailed": {
        ...
        "template": "Dear {#var#}, your Property EMI of Rs.{#var#} is due on {#var#}. Installment {#var#}. Please pay on time. MemoraAI by ELONIOT SOFTWARE",
        "variables": ["customer_name", "amount", "due_date", "installment_no"],
        "type": "transactional"
    },
    "payment_reminder": {
        ...
        "template": "Dear Customer, your Property EMI payment of Rs.{#var#} is due on {#var#}. Please pay before due date to avoid late charges. Login to MemoraAI SAAS by - ELONIOT SOFTWARE",
    ...
    "visit_confirmed": {
        ...
        "template": "Dear {#var#}, your site visit is confirmed on {#var#} at {#var#}. Our representative will assist you. MemoraAI by ELONIOT SOFTWARE",
    ...
    "visit_reminder": {
        ...
        "name": "Visit Reminder",
        "template": "Dear {#var#}, reminder for your site visit tomorrow at {#var#}. We look forward to meeting you. MemoraAI by ELONIOT SOFTWARE",
    ...
    "visit_rescheduled": {
        ...
        "template": "Dear {#var#}, your site visit has been rescheduled to {#var#} at {#var#}. Thank you for understanding. MemoraAI by ELONIOT SOFTWARE",
    ...
    "document_ready": {
        ...
        "name": "Document Ready",
        "template": "Dear Customer, your property document is ready for download. Please login to MemoraAI portal at https://memoraai.in to access. - ELONIOT SOFTWARE",
        "variables": [],
        "type": "service"
    },
    "agreement_ready": {
        ...
        "template": "Dear {#var#}, your property sale agreement is ready. Please visit our office with required documents. MemoraAI by ELONIOT SOFTWARE",
    ...
    "registration_done": {
        ...
        "template": "Dear {#var#}, property registration completed successfully. Registration No: {#var#}. Congratulations! MemoraAI by ELONIOT SOFTWARE",
    ...
    "welcome": {
        ...
        "name": "Welcome",
        "template": "Welcome {#var#}! You can now track your bookings and payments at MemoraAI portal. Thank you. ELONIOT SOFTWARE",
        "variables": ["customer_name"],
        "type": "service"
    },
    "new_lead_assigned": {
        ...
        "template": "Hi {#var#}, new lead assigned:{#var#}. Please follow up today. MemoraAI by ELONIOT SOFTWARE",
    ...
    "follow_up_reminder": {
        ...
        "name": "Follow-up",
        "template": "Hi {#var#}, This is a reminder to follow up on your Real Estate Project Lead - {#var#} registered in MemoraAI CRM. Action is due today. - MemoraAI Remind",
        "variables": ["staff_name", "lead_name"],
        "type": "service"
    }
}
